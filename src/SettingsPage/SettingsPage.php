...
class SettingsPage {
	...
	public function enqueue() {
		wp_enqueue_style( 'control-listings', CTRL_LISTINGS_ASSETS . '/settings/settings.css', '', '2.1.5' );
		...
		wp_enqueue_script( 'control-listings', CTRL_LISTINGS_ASSETS . '/settings/settings.js', array( 'jquery' ), '2.1.5', true );
