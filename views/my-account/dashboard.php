    ...
    <ul class="nav flex-lg-column nav-pills" id="myAccount" role="tablist">
        ...
        foreach (control_listing_get_account_menu_items() as $endpoint => $label) : 
                ...
                <li class="nav-item" role="presentation">
                    <a id="<?php echo esc_attr($endpoint) ?>-tab" class="<?php echo esc_attr(control_listing_dashboard_menu_item_classes($endpoint)) ?>" href="<?php echo esc_url(control_listing_get_account_endpoint_url($endpoint)) ?>" role="tab"><?php echo esc_attr($label) ?></a>
                </li>
                <?php
                $count++;
        endforeach;
