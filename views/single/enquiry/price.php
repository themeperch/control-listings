<div class="price-wrapper d-flex gap-10 flex-column flex-md-row align-items-md-center justify-content-md-between">    
    ...
    <?php echo control_listings_get_price_html(); ?>  
    </div>  
    <?php 
    ...
    if(!empty($buttons)){
        foreach ($buttons as $button) {
            ...
            printf('<a href="%s" class="btn btn-primary btn-enquiry">%s%s</a>', esc_url($button['link']), esc_attr($button['title']), control_listings_get_icon_svg('ui', 'cart', 24));
        }
    }
    ?>
</div>
